...
- [ ] **FOUN-06**: All user data syncs to cloud storage reliably
- [ ] **FOUN-07**: App works offline for cached data (recipes, pantry, meal plans)

### Pantry Scanning

- [ ] **PANT-01**: User can take a photo of their fridge and AI identifies visible food items
...
- [ ] **PANT-06**: Pantry inventory persists and updates across multiple scans (reconciliation)
...
- [ ] **RECP-05**: Imported recipes are parsed into structured format (title, ingredients with quantities/units, steps, times, servings)
- [ ] **RECP-06**: User can view, edit, and delete recipes in their library
- [ ] **RECP-07**: User can search recipes by keyword
- [ ] **RECP-08**: User can favorite recipes
- [ ] **RECP-09**: User can adjust serving sizes and ingredient quantities scale accordingly
- [ ] **RECP-10**: User can browse AI-suggested recipes from the internet based on preferences

### Meal Planning

- [ ] **PLAN-01**: User can generate a weekly dinner plan with AI
- [ ] **PLAN-02**: AI meal plans consider pantry inventory, preferences, and recipe library
...
- [ ] **PLAN-05**: User can swap individual meals in a generated plan
- [ ] **PLAN-06**: User can view meal plan in a weekly calendar view
- [ ] **PLAN-07**: Cooking a planned meal auto-deducts ingredients from pantry inventory
