...
Last activity: 2026-05-04 - Completed quick task 12: Extend mealPlanner to populate per-serving nutrition on plan entries (migration 00036 + planner schema + /entries/assign + client prefer-entry-fields). REQUIRES OUT-OF-BAND ACTION: apply migration 00036 to live Supabase before next /generate call.
...
|---|-------------|------|--------|-----------|
| 1 | Build reusable pantry seed + test-recipe generation tooling | 2026-04-23 | 1467611 | [1-build-reusable-pantry-seed-test-recipe-g](./quick/1-build-reusable-pantry-seed-test-recipe-g/) |
| 2 | RemixSheet visual polish: hero images + single primary CTA + overflow menu | 2026-04-23 | 433108d | [2-remixsheet-visual-polish-hero-images-sin](./quick/2-remixsheet-visual-polish-hero-images-sin/) |
