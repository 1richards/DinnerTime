...
**Plans**: 4 plans
Plans:
- [ ] 15-01-PLAN.md — Shared primitives (SymbolIcon, EmptyState/LoadingState/ErrorState, useDirtyFormGuard) + Vitest coverage + purity grep scripts
- [ ] 15-02-PLAN.md — Native stack headers, modal presentation for scan/recipes import, dirty-form guard wiring, HeaderCloseButton
