...
Reference full template: `/home/user/DinnerTime/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/DinnerTime/.claude/get-shit-done/templates/state.md`.
