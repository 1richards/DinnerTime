...
<execution_context>
@/home/user/DinnerTime/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/home/user/DinnerTime/.claude/get-shit-done/workflows/manager.md end-to-end.
