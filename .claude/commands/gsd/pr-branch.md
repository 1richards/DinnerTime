...
<execution_context>
@/home/user/DinnerTime/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @/home/user/DinnerTime/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
